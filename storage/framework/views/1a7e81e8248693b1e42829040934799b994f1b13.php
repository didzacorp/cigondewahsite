          ...
          <div class="card">
            ...
            <div class="body">
              <form id="form_save">
                ...
                <button type="button" class="btn btn-primary waves-effect btn-sm" onclick="save('<?php echo e(url('product')); ?>', 'POST')"><i class="fa fa-check"></i> SAVE</button>
              </form>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cigondewah.site/resources/views/product/add.blade.php ENDPATH**/ ?>