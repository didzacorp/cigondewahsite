          ...
          <div class="card">
            ...
            <div class="body">
              <form id="form_save">
                ...
                <button type="button" class="btn btn-primary waves-effect" onclick="save('<?php echo e(url('customer')); ?>', 'POST', 'edit')"><i class="fa fa-check"></i> SAVE</button>
              </form>
            </div>
          </div>
        </div>
...
</section><?php /**PATH C:\xampp\htdocs\ggwpos\resources\views/customer/edit.blade.php ENDPATH**/ ?>