...
<aside id="leftsidebar" class="sidebar">
  ...
  <div class="menu">
    <ul class="list">
      <li>
        <div class="user-info">
          ...
          <div class="detail">
            ...
            <small><?php echo e(Auth::user()->role === 3 ? "Owner" : (Auth::user()->role === 2 ? "Manager" : "Cashier")); ?></small>
          </div>
        </div>
      </li>
      ...
      <li class="<?php echo e(Request::segment(1) === 'settings' ? 'active open' : null); ?>">
      ...
      <li>
        <a href="<?php echo e(url('logout')); ?>" class="mega-menu" title="Sign Out" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
...
</aside><?php /**PATH /var/www/html/cigondewah.site/resources/views/layouts/left_sidebar.blade.php ENDPATH**/ ?>