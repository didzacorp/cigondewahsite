          ...
          <div class="card">
            ...
            <div class="body">
              <form id="form_save">
                ...
                <button type="button" class="btn btn-primary waves-effect btn-sm" onclick="save('<?php echo e(url('users')); ?>', 'POST')"><i class="fa fa-check"></i> SAVE</button>
              </form>
            </div>
          </div>
        </div>
...
<script src="<?php echo e(asset('assets/js/pages/forms/dropify.js')); ?>"></script><?php /**PATH /var/www/html/cigondewah.site/resources/views/users/add.blade.php ENDPATH**/ ?>