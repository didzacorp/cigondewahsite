            ...
            <div class="body">
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane in active" id="products">
                  <button type="button" class="btn btn-danger btn-sm pull-right waves-effect" onclick="destroy('<?php echo e(url('product')); ?>', 'DELETE')"><i class="fa fa-trash"></i> Delete</button>
                  <button type="button" class="btn btn-warning btn-sm pull-right waves-effect" onclick="edit('<?php echo e(url('product')); ?>', 'GET')"><i class="fa fa-pencil"></i> Edit</button>
                  <button type="button" class="btn btn-primary btn-sm pull-right waves-effect" onclick="add('<?php echo e(url('product/create')); ?>', 'GET')"><i class="fa fa-plus"></i> Add</button>
                ...
                <div role="tabpanel" class="tab-pane" id="categories">
                  <button type="button" class="btn btn-danger btn-sm pull-right waves-effect" onclick="destroy('<?php echo e(url('product_category')); ?>', 'DELETE')"><i class="fa fa-trash"></i> Delete</button>
                  <button type="button" class="btn btn-warning btn-sm pull-right waves-effect" onclick="editModal('<?php echo e(url('product_category')); ?>', 'category_c')"><i class="fa fa-pencil"></i> Edit</button>
                  <button type="button" class="btn btn-primary btn-sm pull-right waves-effect" onclick="addModal('<?php echo e(url('product_category/create')); ?>')"><i class="fa fa-plus"></i> Add</button>
                  <div class="table-responsive">
                    <table class="table table-hover table-striped">
                      <thead>
                        <tr>
                ...
                <div role="tabpanel" class="tab-pane" id="brands">
                  <button type="button" class="btn btn-danger btn-sm pull-right waves-effect" onclick="destroy('<?php echo e(url('product_brand')); ?>', 'DELETE')"><i class="fa fa-trash"></i> Delete</button>
                  <button type="button" class="btn btn-warning btn-sm pull-right waves-effect" onclick="editModal('<?php echo e(url('product_brand')); ?>', 'brand_c')"><i class="fa fa-pencil"></i> Edit</button>
                  <button type="button" class="btn btn-primary btn-sm pull-right waves-effect" onclick="addModal('<?php echo e(url('product_brand/create')); ?>')"><i class="fa fa-plus"></i> Add</button>
                  <div class="table-responsive">
                    <table class="table table-hover table-striped">
                      <thead>
                        <tr>
                ...
                <div role="tabpanel" class="tab-pane" id="groups">
                  <button type="button" class="btn btn-danger btn-sm pull-right waves-effect" onclick="destroy('<?php echo e(url('product_group')); ?>', 'DELETE')"><i class="fa fa-trash"></i> Delete</button>
                  <button type="button" class="btn btn-warning btn-sm pull-right waves-effect" onclick="editModal('<?php echo e(url('product_group')); ?>', 'group_c')"><i class="fa fa-pencil"></i> Edit</button>
                  <button type="button" class="btn btn-primary btn-sm pull-right waves-effect" onclick="addModal('<?php echo e(url('product_group/create')); ?>')"><i class="fa fa-plus"></i> Add</button>
                  <div class="table-responsive">
                    <table class="table table-hover table-striped">
                      <thead>
                        <tr>
                ...
                <div role="tabpanel" class="tab-pane" id="units">
                  <button type="button" class="btn btn-danger btn-sm pull-right waves-effect" onclick="destroy('<?php echo e(url('product_unit')); ?>', 'DELETE')"><i class="fa fa-trash"></i> Delete</button>
                  <button type="button" class="btn btn-warning btn-sm pull-right waves-effect" onclick="editModal('<?php echo e(url('product_unit')); ?>', 'unit_c')"><i class="fa fa-pencil"></i> Edit</button>
                  <button type="button" class="btn btn-primary btn-sm pull-right waves-effect" onclick="addModal('<?php echo e(url('product_unit/create')); ?>')"><i class="fa fa-plus"></i> Add</button>
                  <div class="table-responsive">
                    <table class="table table-hover table-striped">
                      <thead>
                        <tr>
...
<?php /**PATH /var/www/html/cigondewah.site/resources/views/product/main.blade.php ENDPATH**/ ?>