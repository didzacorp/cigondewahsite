...
<script src="<?php echo e(asset('assets/bundles/sparkline.bundle.js')); ?>"></script> <!-- Sparkline Plugin Js -->
...
<script src="<?php echo e(asset('assets/js/cruds.js')); ?>"></script>


<script src="<?php echo e(asset('assets/plugins/jquery-validation/jquery.validate.js')); ?>"></script> <!-- Jquery Validation Plugin Css -->
<script src="<?php echo e(asset('assets/plugins/nestable/jquery.nestable.js')); ?>"></script> <!-- Jquery Nestable -->
<script src="<?php echo e(asset('assets/plugins/dropify/js/dropify.js')); ?>"></script>
<script src="<?php echo e(asset('assets/plugins/jquery-inputmask/jquery.inputmask.bundle.js')); ?>"></script> <!-- Input Mask Plugin Js -->
...
<script src="<?php echo e(asset('assets/js/pages/forms/dropify.js')); ?>"></script>
...
</script><?php /**PATH /var/www/html/cigondewah.site/resources/views/layouts/script.blade.php ENDPATH**/ ?>